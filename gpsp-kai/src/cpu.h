...
#define ROM_TRANSLATION_CACHE_SIZE (1024 * 512 * 4)  /* 2MB */
#define RAM_TRANSLATION_CACHE_SIZE (1024 * 512 * 1)  /* 512 KB */
#define BIOS_TRANSLATION_CACHE_SIZE (1024 * 128 * 1) /* 128 KB */
