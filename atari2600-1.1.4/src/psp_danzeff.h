...
#define  DANZEFF_LDIFFA          3
#define  DANZEFF_LDIFFB          4
#define  DANZEFF_RDIFFA          5
#define  DANZEFF_RDIFFB          6
#define  DANZEFF_PAUSE           7
#define  DANZEFF_SEL             8
#define  DANZEFF_RESET           9
