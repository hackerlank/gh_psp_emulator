              ...
              if(nds.VCount==192)
                {
              ...
              else if(nds.VCount==263)
                  {
                    ...
                    nds.cycles -= NDSCLK;//(560190<<1);
                    nds.ARM9Cycle -= NDSCLK;//(560190<<1);
                    nds.ARM7Cycle -= NDSCLK;//(560190<<1);
                    nb -= NDSCLK;//(560190<<1);
                    
					
					if(MMU.divRunning)
					{
						MMU.divCycles -= NDSCLK;//(560190 << 1);
					}

					if(MMU.sqrtRunning)
					{
						MMU.sqrtCycles -= NDSCLK;//(560190 << 1);
					}

					if (MMU.CheckTimers)
					{
						if(MMU.timerON[0][0])	nds.timerCycle[0][0] -= NDSCLK;//(560190<<1);
						if(MMU.timerON[0][1])	nds.timerCycle[0][1] -= NDSCLK;//(560190<<1);
						if(MMU.timerON[0][2])	nds.timerCycle[0][2] -= NDSCLK;//(560190<<1);
						if(MMU.timerON[0][3])	nds.timerCycle[0][3] -= NDSCLK;//(560190<<1);

						if(MMU.timerON[1][0])	nds.timerCycle[1][0] -= NDSCLK;//(560190<<1);
						if(MMU.timerON[1][1])	nds.timerCycle[1][1] -= NDSCLK;//(560190<<1);
						if(MMU.timerON[1][2])	nds.timerCycle[1][2] -= NDSCLK;//(560190<<1);
						if(MMU.timerON[1][3])	nds.timerCycle[1][3] -= NDSCLK;//(560190<<1);
					}

					if (MMU.CheckDMAs)
					{
						if(MMU.DMAing[0][0])	MMU.DMACycle[0][0] -= NDSCLK;//(560190<<1);
						if(MMU.DMAing[0][1])	MMU.DMACycle[0][1] -= NDSCLK;//(560190<<1);
						if(MMU.DMAing[0][2])	MMU.DMACycle[0][2] -= NDSCLK;//(560190<<1);
						if(MMU.DMAing[0][3])	MMU.DMACycle[0][3] -= NDSCLK;//(560190<<1);

						if(MMU.DMAing[1][0])	MMU.DMACycle[1][0] -= NDSCLK;//(560190<<1);
						if(MMU.DMAing[1][1])	MMU.DMACycle[1][1] -= NDSCLK;//(560190<<1);
						if(MMU.DMAing[1][2])	MMU.DMACycle[1][2] -= NDSCLK;//(560190<<1);
						if(MMU.DMAing[1][3])	MMU.DMACycle[1][3] -= NDSCLK;//(560190<<1);
					}
				}
