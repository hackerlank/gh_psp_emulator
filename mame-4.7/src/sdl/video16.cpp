...
double mame4all_real_framerate=0.0;
	...
	else
	{
		...
		if (now-start_time>=1000)
		{
			if (mame4all_real_framerate!=0.0)
				mame4all_real_framerate=(mame4all_real_framerate+((double)(mame4all_real_totalframes-start_numframes)))/2.0;
			else
				mame4all_real_framerate=(double)(mame4all_real_totalframes-start_numframes);
			start_time=now;
			start_numframes=mame4all_real_totalframes;
		}
	}
