...
#ifdef PSP_RES
#define GP2X_BYTE_SIZE_SCREEN (480*240)
#else
...
#else
#define gp2x_timer_delay(T) SDL_Delay((Uint32)(((double)(T))*gp2x_sdlwrapper_ticksdivisor))
#define gp2x_timer_read() (unsigned long) (((double)SDL_GetTicks())/gp2x_sdlwrapper_ticksdivisor)
#endif
