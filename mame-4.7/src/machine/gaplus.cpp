    ...
    else if (mode == 1)	/* test mode controls */
    {
        switch (offset)
        {
            ...
            case 6:
                ...
                break;
            case 7:
                return ((readinputport( 4 ) & 0x03) | ((readinputport( 4 ) >> 2) & 0x03));   /* 1P & 2P button 1 */
                break;
        }
    }
    return gaplus_customio_1[offset];
    ...
    else if (mode == 8)  /* IO tests chip 1 */
    {
        switch (offset)
        {
            ...
            case 1:
                ...
                break;
            default:
                return gaplus_customio_r_1(offset);
        }
    }
    return gaplus_customio_r_1(offset);
}
    ...
    if (mode == 5)  /* IO tests chip 2 */
    {
        switch (offset)
        {
            ...
            case 1:
                ...
                break;
            default:
                return gaplus_customio_r_2(offset);
        }
    }
    else if (mode == 4)     /* this values are read only by the game on power up */
    {
        switch (offset)
        {
            ...
            case 7:
                ...
                break;
            default:
                val = gaplus_customio_r_2(offset);
        }
        return val;
    }
	else
    ...
    if (mode == 2)
    {
        switch (offset)
        {
            ...
            case 2:
                ...
                break;
            default:
                return gaplus_customio_r_3(offset);
        }
    }
    else
    {
