#ifndef MAME_DRIVER_H
#define MAME_DRIVER_H
...
struct InputPort
{
	...
	unsigned short default_value;	/* default value for the bits affected */
...
enum { IPT_END=1,IPT_PORT,
	...
	IPT_ANALOG_START,
	IPT_PADDLE, IPT_DIAL, IPT_TRACKBALL_X, IPT_TRACKBALL_Y, IPT_AD_STICK_X, IPT_AD_STICK_Y,	IPT_NONCENTERING_X, IPT_NONCENTERING_Y,
	IPT_ANALOG_END,
...
#define SOUND_NAMCOS1   23
#define SOUND_UPD7759	24
#define SOUND_K007232   25	/* Konami 007232 */
#define SOUND_QSOUND	26	/* CPS-1 Q-Sound */
#define SOUND_SEGAPCM	27	/* System 16 Sega PCM */
#define SOUND_RF5C68	28	/* System 16 RF5C68 */
#define SOUND_YM2612	29	/* System 16 YM2612 */
#define SOUND_YM3438	29	/* System 16 YM3438 (YM2612?) */
...
int is_neogeo_driver(const struct GameDriver *drv);
int is_tmnt_driver(const struct GameDriver *drv);
