...
INPUT_PORTS_START( input_ports )
	...
	PORT_ANALOGX( 0xff, 0x80, IPT_TRACKBALL_X | IPF_PLAYER1, 32, 250, 0, 0, OSD_KEY_LEFT, OSD_KEY_RIGHT, OSD_JOY_LEFT, OSD_JOY_RIGHT, 250 )

	PORT_START /* IN0 - Y AXIS */
	PORT_ANALOGX( 0xff, 0x80, IPT_TRACKBALL_Y | IPF_PLAYER1, 32, 250, 0, 0, OSD_KEY_UP, OSD_KEY_DOWN, OSD_JOY_UP, OSD_JOY_DOWN, 250 )

	PORT_START /* IN0 - BUTTON */
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 )

	PORT_START /* IN1 - X AXIS */
	PORT_ANALOGX( 0xff, 0x80, IPT_TRACKBALL_X | IPF_PLAYER2, 32, 250, 0, 0, OSD_KEY_D, OSD_KEY_G, OSD_JOY2_RIGHT, OSD_JOY2_LEFT, 250 )

	PORT_START /* IN1 - Y AXIS */
	PORT_ANALOGX( 0xff, 0x80, IPT_TRACKBALL_Y | IPF_PLAYER2, 32, 250, 0, 0, OSD_KEY_R, OSD_KEY_F, OSD_JOY2_DOWN, OSD_JOY2_UP, 250 )
...
INPUT_PORTS_START( gridiron_input_ports )
	...
	PORT_START /* IN1 - X AXIS */
	PORT_ANALOGX( 0xff, 0x80, IPT_TRACKBALL_X | IPF_PLAYER2, 100, 63, 0, 0, OSD_KEY_D, OSD_KEY_G, OSD_JOY_LEFT, OSD_JOY_RIGHT, 63 )

	PORT_START /* IN1 - Y AXIS */
	PORT_ANALOGX( 0xff, 0x80, IPT_TRACKBALL_Y | IPF_PLAYER2, 100, 63, 0, 0, OSD_KEY_R, OSD_KEY_F, OSD_JOY_UP, OSD_JOY_DOWN, 63 )
...
static struct MachineDriver machine_driver =
{
	...
	1,	/* FRANXIS 01-03-2006 - 10 CPU slices per frame - seems enough to keep the CPUs in sync */
	0,
