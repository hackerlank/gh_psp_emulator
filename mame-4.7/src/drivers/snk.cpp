...
static void psychos_voice( int which ){
	...
	switch( which ){
		case 0xc0: ADPCM_play( 0, 0x0000, 0x2000*2 ); break; 
		case 0xc1: ADPCM_play( 0, 0x3000, 0x1000*2 ); break; 
		case 0xc2: ADPCM_play( 0, 0x4000, 0x2000*2 ); break; 
		case 0xc3: ADPCM_play( 0, 0x6000, 0x2000*2 ); break; 
		case 0xc4: ADPCM_play( 0, 0x8000, 0x2000*2 ); break; 
		case 0xc5: break; 
		case 0xc6: break; 
		case 0xc7: break; 
		case 0xe4: break; 
		...
		case 0xea: ADPCM_play( 0, 0x2000, 0x1000*2 ); break; 
		case 0xeb:
		break;
	}
}
...
#define ROTARY \
        PORT_START \
        PORT_ANALOGX( 0xff, 0x00, IPT_DIAL, 25, 0, 0, 0, 0, 0, OSD_JOY_FIRE5, OSD_JOY_FIRE6, 16 ) \
        PORT_START \
        PORT_ANALOGX( 0xff, 0x00, IPT_DIAL | IPF_PLAYER2, 25, 0, 0, 0, 0, 0, OSD_JOY2_FIRE5, OSD_JOY2_FIRE6, 16 )
...
/* three z80s with two AY-3-8910 */
	...
	ROM_LOAD( "hal21p10.bin",   0x00000, 0x4000, 0x3b6941a5 )
...
/* three z80s with two AY-3-8910 */
	ROM_REGION(0x10000)	/* 64k for cpuA code */
	ROM_LOAD( "m1",    0x00000, 0x2000, 0x2314c696 )
	ROM_LOAD( "m2",    0x02000, 0x2000, 0x74ba5799 )

	ROM_REGION(0x10000)	/* 64k for cpuB code */
	ROM_LOAD( "pa1",   0x00000, 0x2000, 0x0008d791 )
	ROM_LOAD( "pa2",   0x02000, 0x2000, 0x9457003c )
	ROM_LOAD( "pa3",   0x04000, 0x2000, 0x54c33ecb )

	ROM_REGION(0x10000)	/* 64k for sound code */
	ROM_LOAD( "pb1",   0x00000, 0x2000, 0x3b6941a5 )
