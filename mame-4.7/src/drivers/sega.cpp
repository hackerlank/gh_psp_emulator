...
void zektor_sh_speech_w (int offset, int data);
...
static const char *zektor_sample_names[] =
{
	...
	"zk12.sam",
	"zk13.sam",
        "elim1.sam",  /* 19 fireball */
        "elim2.sam",  /* 20 bounce */
        "elim3.sam",  /* 21 Skitter */
        "elim4.sam",  /* 22 Eliminator */
        "elim5.sam",  /* 23 Electron */
        "elim6.sam",  /* 24 fire */
        "elim7.sam",  /* 25 thrust */
        "elim8.sam",  /* 26 Electron */
        "elim9.sam",  /* 27 small explosion */
        "elim10.sam", /* 28 med explosion */
        "elim11.sam", /* 29 big explosion */
    0	/* end of array */
};

static struct Samplesinterface zektor_samples_interface =
{
	7 /* only speech for now */
};
