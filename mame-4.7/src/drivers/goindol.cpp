...
INPUT_PORTS_START( input_ports )
	...
	PORT_BITX(0x80, IP_ACTIVE_LOW, IPT_COIN1 | IPF_IMPULSE, "Coin[1]", IP_KEY_DEFAULT, IP_JOY_DEFAULT, 1)
	...
	PORT_BITX(0x80, IP_ACTIVE_LOW, IPT_COIN2 | IPF_IMPULSE, "Coin[2]", IP_KEY_DEFAULT, IP_JOY_DEFAULT, 1)
	...
	PORT_DIPSETTING(    0x00, "On" )
	PORT_DIPNAME( 0x20, 0x00, "Demo_Sounds", IP_KEY_NONE )
	PORT_DIPSETTING(    0x20, "Off" )
	PORT_DIPSETTING(    0x00, "On")
	PORT_BITX(    0x40, 0x40, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Invulnerability", IP_KEY_NONE, IP_JOY_NONE,0 )
	PORT_DIPSETTING(    0x40, "Off" )
	PORT_DIPSETTING(    0x00, "On" )
	PORT_BITX(    0x80, 0x80, IPT_DIPSWITCH_NAME | IPF_TOGGLE, "Service_Mode", OSD_KEY_F2, IP_JOY_NONE,0 )
	...
	PORT_DIPSETTING(    0x04, "Off" )
	PORT_DIPSETTING(    0x00, "On" )
	PORT_DIPNAME( 0x38, 0x00, "Coinage", IP_KEY_NONE )
	PORT_DIPSETTING(    0x28, "3C_1C" )
	PORT_DIPSETTING(    0x20, "2C_1C" )
	PORT_DIPSETTING(    0x00, "1C_1C" )
	PORT_DIPSETTING(    0x08, "1C_2C" )
	PORT_DIPSETTING(    0x10, "1C_3C" )
	PORT_DIPSETTING(    0x18, "1C_4C" )
	PORT_DIPSETTING(    0x30, "1C_5C" )
	PORT_DIPSETTING(    0x38, "1C_6C" )
...
static int hiload(void)
{
        ...
        if (memcmp(&RAM[0xc076],"\x05\x00\x27",3) == 0)
	{
		...
		if ((f = osd_fopen(Machine->gamedrv->name,0,OSD_FILETYPE_HIGHSCORE,0)) != 0)
		{
                        ...
                        fast_memcpy(&RAM[0xc0d8], &RAM[0xc076], 2);
                        osd_fclose(f);
		}
