...
context_end:
fill: .long 0     ! safety gap, so z80_reset_4 can use 32-bit transfers
...
! void z80_raise_IRQ_4(UBYTE vector)
...
! void z80_lower_IRQ_4(void)
! Lowers the IRQ line.
.align 5
.global _z80_lower_IRQ_4
_z80_lower_IRQ_4:
	mov #0,r0
...
! int z80_get_context_4_size(void)
! Returns the size of the context, in bytes
.align 5
.global _z80_get_context_4_size
_z80_get_context_4_size:
...
! void z80_set_context_4(void *context)
! Copy the given context to the current Z80.
.align 5
.global _z80_set_context_4
_z80_set_context_4:
...
! void z80_get_context_4(void *context)
! Copy the current Z80 to the given context.
.align 5
.global _z80_get_context_4
_z80_get_context_4:
...
! int z80_get_cycles_elapsed_4(void)
! Returns the number of cycles emulated since z80_emulate_4 was called.
.align 5
.global _z80_get_cycles_elapsed_4
_z80_get_cycles_elapsed_4:
...
! void z80_stop_emulating_4(void)
...
.align 5
.global _z80_stop_emulating_4
_z80_stop_emulating_4:
...
! void z80_do_wait_states_4(int n)
! Halts the CPU temporarily, to execute 'n' memory wait states.
.align 5
.global _z80_do_wait_states_4
_z80_do_wait_states_4:
...
! UWORD z80_get_reg_4(z80_register reg)
! Return the value of the specified register.
.align 5
.global _z80_get_reg_4
_z80_get_reg_4:
	extu.w r4,r4
	mov #11,r1
	cmp/hi r1,r4
...
! void z80_set_reg_4(z80_register reg, UWORD value)
! Set the specified register to a new value.
.align 5
.global _z80_set_reg_4
_z80_set_reg_4:
	extu.w r4,r4
	mov #11,r1
	cmp/hi r1,r4
...
! void z80_init_memmap_4(void)
! Reset the current memory map
.align 5
.global _z80_init_memmap_4
_z80_init_memmap_4:
...
! void z80_map_write_4(UWORD start, UWORD end, UBYTE *memory)
! Moves a Z80_MAP_MAPPED area to use a different region of memory
! start/end = the area it covers (must be page-aligned)
! memory = the ROM/RAM to read from
.align 5
.global _z80_map_write_4
_z80_map_write_4:
...
! void z80_add_write_4(UWORD start, UWORD end, int method, void *data)
! Add a WRITE memory handler to the memory map
! start/end = the area it covers
! method = 0 for direct, 1 for handled
! data = RAM for direct, handler for handled
.align 5
.global _z80_add_write_4
_z80_add_write_4:
...
! void z80_set_in_4(UBYTE (*handler)(UWORD port))
! Set the IN port handler to the given function
.align 5
.global _z80_set_in_4
_z80_set_in_4:
	mov.l _z80_In_si,r0
	rts
	mov.l r4,@r0
...
! void z80_set_out_4(void (*handler)(UWORD port, UBYTE value))
! Set the OUT port handler to the given function
.align 5
.global _z80_set_out_4
_z80_set_out_4:
...
! void z80_set_reti_4(void (*handler)(void))
! Set the RETI handler to the given function
.align 5
.global _z80_set_reti_4
_z80_set_reti_4:
...
! void z80_set_fetch_callback_4(void (*handler)(UWORD pc))
! Set the fetch callback to the given function
.align 5
.global _z80_set_fetch_callback_4
_z80_set_fetch_callback_4:
