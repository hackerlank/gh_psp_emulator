...
# define MENU_SET_CDAUDIO       3
# define MENU_SET_JOYSTICK      4
...
# define MENU_SET_ANALOG       12
# define MENU_SET_AUTOFIRE_T   13
# define MENU_SET_AUTOFIRE_M   14
# define MENU_SET_CLOCK        15
# define MENU_SET_CDCLOCK      16

# define MENU_SET_LOAD         17
# define MENU_SET_SAVE         18
# define MENU_SET_RESET        19
                                 
# define MENU_SET_BACK         20
...
# endif
        ...
        (new_pad & PSP_CTRL_LEFT  )) 
    {
      ...
      switch (cur_menu_id ) 
      {
        ...
        break;              
        case MENU_SET_AUTOFIRE_M  : hugo_auto_fire_mode = ! hugo_auto_fire_mode;
        break;              
