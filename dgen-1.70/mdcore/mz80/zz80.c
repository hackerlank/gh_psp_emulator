...
#ifdef _PSP10
static UINT8 malloc_pbAddAdcTable[ 256*256*2 ] ;
static UINT8 malloc_pbSubSbcTable[ 256*256*2 ] ;
#endif //_PSP10
...
void mz80init(void)
{
	...
	{
#ifdef _PSP10
		pbAddAdcTable = malloc_pbAddAdcTable ;
#else //_PSP10
...
#ifdef _PSP10
		pbSubSbcTable = malloc_pbSubSbcTable ;
#else //_PSP10
